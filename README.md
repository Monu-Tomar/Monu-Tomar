...
* Frameworks/Libraries: React, Redux, JQuary, Bootstrap, Tailwind CSS
...
Kichen Kingdom ( https://kitchen-kingdom.vercel.app/ )

The React project is a web application designed to provide users for best food browsing and management experience.
The project is built using the following technologies:
* HTML, CSS, React JS (JavaScript library), Redux, Tialwind css
⚡ Optimize for Mobile Devices:
* Ensure the application is optimized for mobile devices, providing a seamless user experience across various screen sizes and devices.
